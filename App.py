...
with open('C:\projects\Movie_Recommender_App-master\Data\movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open('C:\projects\Movie_Recommender_App-master\Data\movie_titles.json', 'r+', encoding='utf-8') as f:
...
def run():
    img1 = Image.open('C:\projects\Movie_Recommender_App-master\meta\movielogo.png')
    img1 = img1.resize((250, 250), )
    st.image(img1, use_column_width=False)
    st.title("Movie Recommender System")
    st.markdown('''<h4 style='text-align: left; color: #d73b5c;'>IMDB 5000 Movies Dataset</h4>''',
